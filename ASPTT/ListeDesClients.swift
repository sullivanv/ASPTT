...
class ListeDesClients: UIViewController {
    
    @IBOutlet weak var hide: UIView!
    @IBOutlet weak var nomclient: UILabel!
    ...
    func my_push() {
        ...
        let url:NSURL = NSURL(string:"https://nodeapi-robotbobtm.c9users.io:8081/api/print_planningcoach")!
